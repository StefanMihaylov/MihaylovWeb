...
namespace Mihaylov.Site.Database.Migrations
{
    ...
    [Migration("20201008220635_addMediafiles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mihaylov.Site.Database.Models.MediaFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mihaylov.Site.Database.Models.MediaFile", b =>
                {
                    b.HasOne("Mihaylov.Site.Database.Models.Account", "Account")
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Mihaylov.Site.Database.Models.AccountType", "Source")
                        .WithMany()
