...
namespace Mihaylov.Api.Other.Database.Migrations.MihaylovOtherClusterDb
{
    ...
    [Migration("20260303140104_Deleted-Application")]
    partial class DeletedApplication
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mihaylov.Api.Other.Database.Cluster.Models.Application", b =>
                {
                    ...
                    b.HasOne("Mihaylov.Api.Other.Database.Cluster.Models.ParserSetting", "ParserSetting")
                        .WithMany()
                        .HasForeignKey("ParserSettingId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("Deployment");

                    b.Navigation("ParserSetting");
                });
