...
namespace Mihaylov.Api.Site.Client
{
    ...
    #pragma warning restore 8618 // Set by constructor via BaseUrl property
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PersonGrid> PersonsAsync(int? accountTypeId, int? accountStatusId, string name, string accountName, int? page, int? pageSize)
        {
            return PersonsAsync(accountTypeId, accountStatusId, name, accountName, page, pageSize, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PersonGrid> PersonsAsync(int? accountTypeId, int? accountStatusId, string name, string accountName, int? page, int? pageSize, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            ...
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("AccountStatusId")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(accountStatusId, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
            }
            if (name != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("Name")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(name, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
