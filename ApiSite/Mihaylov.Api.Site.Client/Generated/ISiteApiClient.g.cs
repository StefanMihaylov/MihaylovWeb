...
namespace Mihaylov.Api.Site.Client
{
    ...
    public partial interface ISiteApiClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<DefaultFilter>> DefaultFiltersAsync();

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<DefaultFilter>> DefaultFiltersAsync(System.Threading.CancellationToken cancellationToken);

        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DefaultFilter> DefaultFilterAsync();

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DefaultFilter> DefaultFilterAsync(System.Threading.CancellationToken cancellationToken);

        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DefaultFilter> AddDefailtFilterAsync(AddDefaultFilterModel body);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DefaultFilter> AddDefailtFilterAsync(AddDefaultFilterModel body, System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task RemoveAnswerAsync(long? id);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task RemoveAnswerAsync(long? id, System.Threading.CancellationToken cancellationToken);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.5.0.0 (NJsonSchema v11.4.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AddDefaultFilterModel
    {
        ...
        [Newtonsoft.Json.JsonProperty("isArchive", Required = Newtonsoft.Json.Required.Always)]
        ...
        public static AddDefaultFilterModel FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<AddDefaultFilterModel>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class DefaultFilter
    {
        ...
        public static DefaultFilter FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<DefaultFilter>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class PersonFormatedStatistics
    {
        ...
        [Newtonsoft.Json.JsonProperty("headerData", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IEnumerable<string> HeaderData { get; set; }

        [Newtonsoft.Json.JsonProperty("gridData", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IEnumerable<System.Collections.Generic.IEnumerable<string>> GridData { get; set; }

        [Newtonsoft.Json.JsonProperty("footerData", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IEnumerable<string> FooterData { get; set; }
    ...
    public partial class PersonStatistics
    {
        ...
        [Newtonsoft.Json.JsonProperty("activeAccounts", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IEnumerable<StringPersonStatisticsPairGeneric> ActiveAccounts { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("totalAccountCount", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
